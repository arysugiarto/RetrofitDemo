...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retrofit2.Call<EmployeeList> call = service.getEmployeeData(100);
        ...
        call.enqueue(new Callback<EmployeeList>() {
            @Override
            public void onResponse(retrofit2.Call<EmployeeList> call, Response<EmployeeList> response) {
                generateEmployeeList(response.body().getEmployeeArrayList());
            }

            @Override
            public void onFailure(retrofit2.Call<EmployeeList> call, Throwable t) {
